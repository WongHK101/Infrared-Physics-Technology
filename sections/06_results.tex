...
reach 87.08\% and 94.29\% homography availability, respectively. RIFT2 adds an infrared-visible
classical reference point and completes all evaluated pairs. Raw MINIMA and RoMa also produce
homographies for all pairs, while LoFTR and XoFTR remain near-saturated under the same
manifest-based evaluation. This result sharpens the role of UAV-TAlign: the framework targets the
decision layer that remains after strong pairwise homography evidence is available.
