...
\begin{figure}[t]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.05\textwidth]{figures/fig_scene_reliability_principle_image2.png}}
...
\begin{figure}[t]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.15\textwidth]{figures/fig_uav_talign_overview_image2.png}}
\caption{Paper-level overview of UAV-TAlign-12K and UAV-TAlign. The benchmark first measures
pairwise homography evidence, while the proposed framework performs scene-level evidence
...
protocol.
\item We show through classical and modern off-the-shelf baselines, reliability
