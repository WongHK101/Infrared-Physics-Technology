...
\section{UAV-TAlign Reference Method}

\subsection{Problem Formulation}

To instantiate the scene-level track of UAV-TAlign-12K, we provide UAV-TAlign as a reference
alignment method. For each scene, the input is
...
\begin{figure}[t]
\centering
\makebox[\textwidth][c]{\includegraphics[width=1.18\textwidth]{figures/fig_uav_talign_architecture_image2.png}}
\caption{Detailed architecture of UAV-TAlign. A progressive frame schedule and deterministic
representative selection provide pairwise evidence for geometry screening. Quality-weighted
homography hypotheses are consolidated by robust scene consensus, after which QA-aware
verification drives the canonical gate and the complementary reliability-ranking branch.}
