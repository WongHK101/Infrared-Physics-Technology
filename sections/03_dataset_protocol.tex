...
\begin{figure}[t]
\centering
\includegraphics[width=\textwidth]{figures/fig02_benchmark_protocol.pdf}
\caption{Organization of UAV-TAlign-12K and its multi-level protocol. (a) Integrity-checked pair
counts across 15 scenes. (b) Coverage of illumination, infrared rendering, and view attributes.
(c) The frozen, versioned manifest maps the collection to the official 6,037-pair evaluation
split. (d) Complementary tracks evaluate pairwise evidence, scene products, and the operating
profile.}
