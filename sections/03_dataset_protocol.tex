...
UAV-TAlign-1K is derived from the larger UAV-TAlign-12K collection, which contains 6039
RGB-thermal pairs and 12078 images across the same 15 UAV scenes. We use the 1K subset as the
formal evaluation split in this paper so that all baselines, diagnostics, and ablations share a
fixed, reproducible scene definition while preserving the key variation present in the larger
collection.
